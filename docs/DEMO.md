...
1. Sign in as `shopper1@healthconnect.dev`, go to **/shop**.
...
1. Sign in as `admin@healthconnect.dev` → **Dispatch board**.
2. Look at the tiles:
...
5. Sign in as `karim@healthconnect.dev` → the **driver console**.

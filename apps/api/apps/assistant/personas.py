...
PERSONAS: dict[str, Persona] = {
    GUEST: Persona(
        ...
        intents=UNIVERSAL_INTENTS + ("search_availability", "prescription_required", "find_pharmacies", "how_it_works", "sign_in_needed"),
        ...
        suggestions=("Who has Panadol in stock?", "How does delivery work?", "Do I need a prescription to order?"),
    ),
    CUSTOMER: Persona(
        key=CUSTOMER,
        ...
        + ("search_availability", "prescription_required", "find_pharmacies", "how_it_works", "order_status", "prescription_status", "refill_status"),
        greeting="Hi. I can check on your orders, your prescriptions, or find a medicine in stock near you.",
        suggestions=("Where is my latest order?", "When does my prescription expire?", "Find paracetamol near me"),
    ),
    DOCTOR: Persona(
        key=DOCTOR,
        ...
        suggestions=("How many renewal requests are waiting?", "Which prescriptions expire this week?", "Is amoxicillin prescription-only?"),
    ),
    PHARMACY: Persona(
        key=PHARMACY,
        ...
        suggestions=("What is running low?", "How did we trade over the last 30 days?", "Any online orders waiting?"),
    ),
    ADMIN: Persona(
        key=ADMIN,
        ...
        suggestions=("How many applications are pending?", "What does dispatch look like right now?", "Give me a platform overview"),
    ),
    DRIVER: Persona(
        key=DRIVER,
        ...
        suggestions=("What is my next stop?", "How many stops are left?"),
    ),
}
